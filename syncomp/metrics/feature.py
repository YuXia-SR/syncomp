...
def compute_visit_prob_per_store(df, sample_size=1000, random_state=0):
    ...
    return store_visit_prob_per_store.sample(sample_size, random_state=random_state)
...
def compute_purchase_prob_per_product(df, sample_size=1000, random_state=0):
    ...
    return product_purchase_prob_per_product.sample(sample_size, random_state=random_state)
...
def compute_customer_retention_per_store(df, window_length=30, sample_size=1000, random_state=0):
    ...
    return customer_retention.sample(sample_size, random_state=random_state)
